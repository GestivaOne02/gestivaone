...
export default function LandingPymes() {
  return (
    <div className="min-h-screen bg-[#0e0e17] text-foreground selection:bg-brand-500/30 selection:text-brand-300">
      <SEOHead
        title="Software de Gestión Comercial y Finanzas para PyMEs — GestivaOne"
        description="Plataforma de administración para pequeñas y medianas empresas: reportes en tiempo real, empleados y egresos."
        canonical="https://www.gestivaone.com/pymes"
        keywords="software pymes Colombia, administración empresas, reportes financieros PDF Excel, control egresos"
      />
      ...
      <header className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
        ...
        <h1 className="text-4xl sm:text-5xl font-black text-white max-w-4xl mx-auto tracking-tight leading-tight">
          Administración Integral y Analíticas para <span className="text-brand-400">PyMEs</span>
        </h1>
        <p className="text-base sm:text-lg text-muted-400 max-w-2xl mx-auto leading-relaxed">
          Toma decisiones estratégicas con reportes de utilidades en tiempo real, gestión de nómina/empleados y exportación a PDF y Excel.
        </p>
