            ...
            <div className="lg:col-span-7 bg-surface-800 border border-subtle p-6 sm:p-8 rounded-3xl space-y-4 shadow-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input id="contact-name" name="name" type="text" autoComplete="name" placeholder="Ej: Randy Mendoza" className="w-full bg-surface-700 border border-subtle rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:ring-1 focus:ring-brand-500" />
                </div>
                <div>
                  ...
                  <input id="contact-email" name="email" type="email" autoComplete="email" placeholder="correo@empresa.com" className="w-full bg-surface-700 border border-subtle rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:ring-1 focus:ring-brand-500" />
                </div>
              </div>
              <div>
                ...
                <input id="contact-subject" name="subject" type="text" autoComplete="off" placeholder="Ej: Consulta sobre el Plan Empresarial" className="w-full bg-surface-700 border border-subtle rounded-xl px-4 py-2.5 text-xs focus:outline-none focus:ring-1 focus:ring-brand-500" />
              </div>
              <div>
